...
from chatanalysis.contracts.run_manifest import finalize_run, start_run, write_manifest
from chatanalysis.detect import DETECTOR_REGISTRY, get_detector
from chatanalysis.discovery import apply_scope, discover_corpus, write_discovery_artifacts
from chatanalysis.discovery.inventory import DiscoverySummary, InventoryRecord
from chatanalysis.normalize import write_normalize_artifacts
from chatanalysis.parse import RawEvent, iter_raw_events, write_parse_artifacts
from chatanalysis.search import SearchFilters, inspect_evidence_record, parse_csv_filters, parse_query, run_search, write_search_result
from chatanalysis.notebooks import export_notebook_artifacts
from chatanalysis.report import generate_report
from chatanalysis.seed import build_seed_run, write_seed_run
from chatanalysis.semantic import SemanticEvidenceSlice, get_semantic_method, write_semantic_run
from chatanalysis.episodes import build_episodes, write_episode_artifacts
from chatanalysis.episodes.loader import iter_evidence_rows
from chatanalysis.validate import run_validation
from chatanalysis.views import build_view
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="chatanalysis")
